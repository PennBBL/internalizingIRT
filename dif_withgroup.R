...
write.csv(proband_results, file=paste0("/home/butellyn/parentchild_psychopathology/data/proband_dif_withgroups_", Sys.Date(), ".csv"), row.names=FALSE)
...
write.csv(proband_results2, file=paste0("/home/butellyn/parentchild_psychopathology/data/proband_dif2_withgroups_", Sys.Date(), ".csv"), row.names=FALSE)
...
# Write out logistic model results and bifactor loadings
write.csv(collateral_results, file=paste0("/home/butellyn/parentchild_psychopathology/data/collateral_dif_withgroups_", Sys.Date(), ".csv"), row.names=FALSE)
...
write.csv(collateral_results2, file=paste0("/home/butellyn/parentchild_psychopathology/data/collateral_dif2_withgroups_", Sys.Date(), ".csv"), row.names=FALSE)
